...
// File: contracts/EdgewareToken.sol
...
// File: contracts/HarmonyBridge.sol
...
contract Bridge is Ownable {
    ...
    function requestSwap(
        ...
        bytes32 hashSwapMessage = this.hashMessage(transferInfo);
        require(
            verifySignatures(hashSwapMessage, signatures),
    ...
    function getAddreessFromSignuture(bytes32 signedMessage, bytes memory signature) public view returns(address) {
